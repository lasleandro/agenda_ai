...
import {
  ArrowLeft, CalendarClock, CheckCircle2, ChevronLeft, ChevronRight,
...
function CreateTab({ onError, onManage }: { onError: (message: string | null) => void; onManage: (tenant: string) => void }) {
  ...
  async function save() {
    ...
    } catch (reason) { onError(reason instanceof Error ? reason.message : "Falha ao criar tarefa."); }
