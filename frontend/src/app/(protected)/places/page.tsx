...
export default function PlacesPage() {
  ...
  useEffect(() => {
    ...
    fetchSession().then((user) =>
      setFinancialEnabled(
        sessionHasFeature(user, "commercial_financials")
      )
    );
  }, []);
  ...
  return (
    <div className="flex-1 flex flex-col min-h-0 p-4 md:p-6 gap-4 overflow-auto">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-semibold tracking-tight">Meus Locais</h1>
      ...
      {places === null && <p className="text-sm text-muted-foreground">Carregando...</p>}
